...
- Containerisierung und Bereitstellung eines full-stack 5G-Testbeds mit Docker Compose, Integration von Open5GS 5GC, O-RAN SC RIC und srsRAN/OCUDU gNB-Komponenten.
...
- Aufbau und Wartung des ReactJS-Frontends sowie NodeJS/Go-Backend-Services für eine hochperformante Handelsplattform.
...
- Aufbau und Release einer Fullstack-RAG-Anwendung: FastAPI-Backend (Python) mit Next.js-Frontend für Dokumenten-Upload, semantische Suche und Chat.
...
- Implementierung von pgvector (HNSW, cosine) für semantische Suche; sämtliche Inference-Aufrufe werden privat durch llama.cpp bedient.
...
- Entwicklung automatisierter Gmail-Alert-Ingestion-Pipelines (LinkedIn, Glassdoor, Indeed) sowie bidirektionaler Google-Sheets-Lifecycle-Tracking.
...
- Entwicklung einer Zero-Backend-Web-App, die beliebige Google Sheets in Live-Dashboards mit clientseitiger CSV-Parserung, KPI-Karten und Diagrammen umwandelt.
