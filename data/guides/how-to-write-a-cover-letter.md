...
- Avoid the flat "I am writing to apply for…" and avoid an information-packed multi-clause first sentence. One clean, genuine idea.

## Rules
- **Tailor per company** — never send a generic letter; mention the specific role and a real "why".
- **Truthful** — no invented experience, skills, metrics, or dates.
- **One idea per sentence**; keep sentences short.
- Lead with the narrative that fits the role: **deep system design / distributed systems**, **research rigor (top grades)**, or **build-from-scratch / ship-it** for startups.
