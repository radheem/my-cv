...
Ilmenau, Germany | +49 1512 3456789 | john.doe@example.com

<!-- SOURCE OF TRUTH (facts) for tailored CVs. Fictional demo persona — see README.
...
### Second Brain - Self-Hosted Document RAG ([repo](https://github.com/johndoe/my-notebook))
...
### O-RAN OSC AIML Framework - AI/ML Platform Engineering ([repo](https://github.com/johndoe-corp/O-RAN-AIML-deployment))
...
### 5G srsRAN + O-RAN RIC Testbed, Docker ([repo](https://github.com/johndoe-corp/srsran-docker))
...
### 5G Testbed - srsRAN and Open5GS, Kubernetes ([repo](https://github.com/johndoe-corp/srsRAN-dep-zmq))
