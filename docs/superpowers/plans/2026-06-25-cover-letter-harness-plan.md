...
- [ ] **Step 1: Write a failing unit test in `tests/test_experiments.py`**
...
- [ ] **Step 2: Run pytest to verify the test fails**
  Run: `pytest tests/test_experiments.py::test_latex_heading_rendering -v`
...
- [ ] **Step 5: Commit changes**
  ```bash
  git add engine/latex.py tests/test_experiments.py
